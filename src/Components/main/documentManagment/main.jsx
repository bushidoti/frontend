...
const Main = (props) => {
    ...
    return (
        <Fragment>
                 <Modal docToggle={props.docToggle} permission={props.permission}  editDocument={props.editDocument} setEditDocument={props.setEditDocument}  modalTitle={props.modalTitle} idNumber={idNumber} setIdNumber={setIdNumber}/>
