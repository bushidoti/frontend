    ...
    const putHandlerAutoIncrement = async () => {
           await axios.put(
            `${Url}/api/autoincrementproperty/1/`,
              {
              airport_furniture_01: form.message === 'دفتر مرکزی' ? form.autoIncrement.airport_furniture_01+1 : form.autoIncrement.airport_furniture_01,
              airport_furniture_02: form.message === 'چابهار' ? form.autoIncrement.airport_furniture_02+1 : form.autoIncrement.airport_furniture_02,
              airport_furniture_03: form.message === 'دزفول' ? form.autoIncrement.airport_furniture_03+1 : form.autoIncrement.airport_furniture_03,
              airport_furniture_04: form.message === 'جاسک' ? form.autoIncrement.airport_furniture_04+1 : form.autoIncrement.airport_furniture_04,
