    ...
    const putHandlerAutoIncrement = async () => {
           await axios.put(
            `${Url}/api/autoincrementproperty/1/`,
              {
              facility_furniture_01: form.message === 'دفتر مرکزی' ? form.autoIncrement.facility_furniture_01+1 : form.autoIncrement.facility_furniture_01,
              facility_furniture_02: form.message === 'چابهار' ? form.autoIncrement.facility_furniture_02+1 : form.autoIncrement.facility_furniture_02,
              facility_furniture_03: form.message === 'دزفول' ? form.autoIncrement.facility_furniture_03+1 : form.autoIncrement.facility_furniture_03,
              facility_furniture_04: form.message === 'جاسک' ? form.autoIncrement.facility_furniture_04+1 : form.autoIncrement.facility_furniture_04,
                   ...
                   {(() => {
                       if(form.isRepair === 'تعمیرات'){
                           ...
                           return(
                               <Fragment>
                                       <div className="col form-floating mb-3">
                                            <input type="text" className="form-control" id="nameFurniture" name='name' value={form.editStatus ? form.formik.values.name : formik.values.name}
